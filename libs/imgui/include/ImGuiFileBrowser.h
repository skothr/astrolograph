...
namespace imgui_addons
{
    ...
    {
        public:
            ImGuiFileBrowser(const std::string &initialPath="");
            ~ImGuiFileBrowser();
        ...
        private:
            ...
            bool loadWindowsDrives(const std::string &initialPath=""); // Helper Function for Windows to load Drive Letters.
            #endif

            #if defined(unix) || defined(__unix__) || defined(__unix) || defined(__APPLE__)
            void initCurrentPath(const std::string &initialPath="");   // Helper function for UNIX based system to load Absolute path using realpath
            #endif
